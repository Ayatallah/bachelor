...
def analyze_data(labels,data,k):
    ...
    #for x in range(len(clustersLengths)):
     #   if(clustersLengths[x]>clustersLengths[index]):
     #      index = x
    #print index
    #global clusterTrial
    #print clusterTrial
    #print (labelsNames[0])[:,1:]
    #if clusterTrial is False:
        #cluster_data(labelsNames[index], 20)
        #clusterTrial = True
        #cluster_data((labelsNames[index])[:,1:], 20)
    #print clusterTrial
