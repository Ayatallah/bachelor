...
problemsNames = np.empty((7610,41), dtype="S15")
...
def analyze_data(labels,data,k):
    ...
    labelsNames = []
    times = []
    #print problemsNames[0]
    #print problemsNames[1]
    #print problemsNames[2]
    #print problemsNames[3]
    for j in range(k):
    ...
    for x in range(len(labelsNames)):
        np.savetxt(
            ...
            header='Data generated by Clustering, in Cluster'+str(x),
            fmt="%s")
    ...
    #f = open("mydata.csv", "w")
    #print labelsNames[0]
    #cluster0 = labelsNames[0]
    #cluster1 = labelsNames[1]
    #cluster2 = labelsNames[2]
    #cluster3 = labelsNames[3]
    #cluster4 = labelsNames[4]
    #cluster5 = labelsNames[5]
    #cluster6 = labelsNames[6]
    #cluster7 = labelsNames[7]
    #cluster8 = labelsNames[8]

    #max(L, key=len)

    #np.savetxt(
    #    f,  # file name
    #    labelsNames,  # formatting, 2 digits in this case
    #    delimiter=',',  # column delimiter
    #    newline='\n',  # new line character
    #    footer='end of Cluster',  # file footer
    #    comments='# ',  # character to use for comments
    #   header='Data generated by Clustering, in Cluster 1',
    #    fmt="%s")
